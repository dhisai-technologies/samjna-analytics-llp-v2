...
import { type NursingSession, nursingTests, users } from "@lib/database";
...
<html dir="ltr" lang="en">
  ...
  <body style="background-color:#ffffff;font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,Oxygen-Sans,Ubuntu,Cantarell,&quot;Helvetica Neue&quot;,sans-serif">
      ...
      <tbody>
        <tr style="width:100%">
          <td><img alt="Samjna Analytics LLP" height="42" src="https://samjna.co.in/logo.png" style="display:block;outline:none;border:none;text-decoration:none;border-radius:21px;width:42px;height:42px" width="42" />
              ...
              <tbody>
                <tr>
                  <td>
                    <a
                      href="{{REPORT_URL}}"
                      style="line-height:100%;text-decoration:none;display:block;max-width:100%;mso-padding-alt:0px;background-color:#7B39ED;border-radius:3px;font-weight:600;color:#fff;font-size:15px;text-align:center;padding:11px 23px 11px 23px"
                      target="_blank"
                      ><span
                        ><!--[if mso
                          ]><i
            ...
            <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#dfe1e4;margin:42px 0 26px" /><a href="http://localhost:3000" style="color:#b4becc;text-decoration:none;font-size:14px" target="_blank">Samjna Analytics LLP</a>
          </td>
        </tr>
      </tbody>
    </table>
	...
	`;
  const html = nursingReportTemplate
