...
const DataTabsContext = React.createContext<Context | null>(null);
...
export function DataTabs(props: {
  ...
  const { children, className, searchParam = "tab", defaultValue } = props;
  ...
  return (
    <DataTabsContext.Provider value={{ defaultValue, hrefFor, searchParam, selected }}>
...
const useContext = () => {
  const context = React.useContext(DataTabsContext);
  if (!context) {
...
export function DataTabsList(props: {
  children: React.ReactNode;
  className?: string;
}) {
  return (
...
export function DataTabsTrigger(props: {
  children: React.ReactNode;
  className?: string;
  value: string;
}) {
...
export function DataTabsContent(props: {
  children: React.ReactNode;
  className?: string;
  value: string;
}) {
