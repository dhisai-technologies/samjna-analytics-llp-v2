...
import { CreateNursingTestDialog } from "./create-nursing-test-dialog";

export function NursingTestsToolbar() {
    ...
    <div className="flex gap-2">
      ...
      {user?.role === "ORGANIZATION" && (
        <>
          ...
          <CreateNursingTestDialog open={open} onOpenChange={setOpen} />
        </>
      )}
    </div>
  );
