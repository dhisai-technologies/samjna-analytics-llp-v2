...
import { deleteNursingSession } from "@/lib/actions";
...
export function getColumns(nursingTestId: string): ColumnDef<NursingSession>[] {
  return [
    {
      accessorKey: "Id",
          ...
          return (
            <div className="flex space-x-2">
              <Button aria-label="View session" variant="ghost" size="icon" asChild>
                <Link href={`${nursingTestId}/sessions/${row.original.id}`}>
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52">
              ...
              <DropdownMenuItem
                onSelect={() => {
                  toast.promise(deleteNursingSession(row.original.id), {
