                    ...
                    <div className="max-w-lg h-full flex flex-col items-start justify-center overflow-hidden">
                      <BoxReveal duration={0.5}>
                        <p className="mt-2 text-sm">
                          ...
                          <span className="text-primary font-semibold">right side screen</span> as fast as possible.
                          After answering click <span className="text-primary font-semibold">Next</span> to move
                          forward. Questions will have a <span className="text-primary font-semibold">time limit</span>{" "}
                          and
                            ...
                            <div className="max-w-lg h-full flex flex-col items-start justify-center overflow-hidden">
                              <BoxReveal duration={0.5}>
                                <p className="mt-2 text-sm">
                                  ...
                                  question and click <span className="text-primary font-semibold">Next</span> when
                                  ready. Questions will have a{" "}
